...
export const styles = StyleSheet.create({
  ...
  detalleParticipanteCard: {
    padding: 16,
    borderRadius: 12,
    marginTop: 8,
    backgroundColor: 'rgba(0, 0, 0, 0.02)',
  },
  detalleParticipanteHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
    marginBottom: 8,
  },
  detalleParticipanteNombre: {
    fontSize: 16,
    fontWeight: '700',
  },
  detalleParticipanteInfo: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
    marginTop: 4,
  },
  detalleParticipanteTexto: {
    fontSize: 14,
    opacity: 0.8,
  },
  detalleFooter: {
